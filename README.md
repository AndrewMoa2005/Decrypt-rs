...
## 关于本工具
![工具的用户界面](./image/interface.png "Optional title")  
...
## 重构说明（2025-5-29，AndrewMoa）
　　本仓库在liuweilhy原始代码的基础上用rust重构，基于fltk-rs重新实现界面，并使用fltk-theme美化，目的是为了学习编程和交流经验。重构之后的软件从未在加密环境中进行过任何测试，不能保证解密效果。请勿用于商业生产和涉密环境，更不得用于任何违法犯罪活动，谢谢合作！
